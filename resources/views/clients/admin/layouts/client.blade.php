...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/clients/css/custum.css') }}">
</head>

<body>
    <!-- Body main wrapper start -->
    <div class="body-wrapper">
        @include('clients.admin.layouts.partials.header')
        
        @hasSection('breadcrumb')
            @include('clients.admin.layouts.partials.breadcrumb')
        @endif
        ...
        @include('clients.admin.layouts.partials.feature')

        @include('clients.admin.layouts.partials.footer')
    ...
    <!-- Custom JS (login/register validation) -->
